...
Solid knowledge of Core JavaScript, Server-Side JavaScript. Strong knowledge of NodeJS
Experienced in Google Cloud service and Kubernetes in particular
Familiar with CI tools (Jenkins, CircleCI…)
Strong knowledge of JS Test Frameworks. Experience in Unit and API Testing
Advanced knowledge of JavaScript Profiling and Debugging and JavaScript Code Quality tools
Strong knowledge in the Code Review Process and Release Strategy
Strong desire and skills to solve non-trivial and challenging problems
Must be a strong full-stack developer using any technology that uses Javascript as backend services, with a minimum of 3-4 years of solid working experience as this role.
Strong experience writing or utilizing RESTful API services and performance tuning for large scale applications
Strong understanding of application engineering/System integration/Security best practices
Strong experience with RDBMS like MySQL, PostgreSQL
The proficient level of spoken and written English
