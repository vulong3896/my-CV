...
%-------------------------------------------
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
	\resumeItem{\textbf{Roadmap alignment}: develop year/quarter/month plan that aligned with company mission and product strategy; assign tasks to members based on product/project requirement and review the delivered result via Jira/Gitlab MR and verbal reports  }
	...
	\resumeItem{\textbf{Performance review} Monitored deliverables via Jira/GitLab MRs (code quality, timeline adherence) and verbal syncs (to solve blockers, collaboration issues). Conducted retrospectives to refine processes and address gaps in execution. }
       \resumeItem{\textbf{Research strategy}: do market research from research and advisory firm like Gartner and also business requirements from both internal and external to bring out the detailed machine learning research plan }
        ...
        \resumeItem{\textbf{MLOps:} designed and built an MLOps system level 3 including model registry, data drift detection, automated training, data version control (DVC) and CI/CD model pipeline}
